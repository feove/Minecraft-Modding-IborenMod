...
- **New Entity** Custom Cow/Spawn Egg/Random Spawn
...
1. Download the `iborenMod-2.2jar` file from the [releases section](#).
...
2. Copy the `iborenMod-2.2.jar` to your `mods/` folder.
3. Launch Minecraft!
