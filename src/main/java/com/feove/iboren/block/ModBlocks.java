...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> IBO_ORE = registerBlock("ibo_ore", () ->
    ...
    public static final RegistryObject<Block> REN_ORE = registerBlock("ren_ore", () ->
            new Block(AbstractBlock.Properties.of(Material.STONE)
                    .harvestLevel(3)
                    .harvestTool(ToolType.PICKAXE)
                    .requiresCorrectToolForDrops()
    ...
    public static final RegistryObject<Block> REN_BLOCK = registerBlock("ren_block", () ->
    ...
    public static final RegistryObject<Block> IBO_BLOCK = registerBlock("ibo_block", () ->
    ...
    private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block) {
        ...
        ModItems.ITEMS.register(name, () -> new BlockItem(toReturn.get(), new Item.Properties().tab(ModItemGroup.IBOREN_GROUP)));
        return toReturn;
    }
